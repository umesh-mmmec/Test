...
export default class VideoCategory extends Component{
    constructor(props) {
      ...
      MoveToNewsDetails = (id) => {
        return this.props.navigation.navigate('VideoDetail',  {selectedNews: id, category: this.state.categoryId});
    }
            ...
            {/* list end */}
            {
              resultObject.map(e => {
                ...
                return(
                  ...
                  >
                  <View style={{ borderWidth:2, borderColor:'#f35925', backgroundColor: 'white', height: 100, borderRadius: 10, flexDirection: 'row', marginBottom: 10 }}>
